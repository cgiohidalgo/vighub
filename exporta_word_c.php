...
<h2><?php echo $row_datos_canvas['segmentos']; ?></h2>
<h5 align="center">
...
<h2><?php echo $row_datos_canvas['propuesta']; ?></h2>
<h5 align="center">
...
<h2><?php echo $row_datos_canvas['canales']; ?></h2>
 <h5 align="center">
...
<h2><?php echo $row_datos_canvas['relacion']; ?></h2>
 <h5 align="center">
...
<h2><?php echo $row_datos_canvas['flujos']; ?></h2>
 <h5 align="center">
...
<h2><?php echo $row_datos_canvas['actividades']; ?></h2>
 <h5 align="center">
...
<h2>Recursos</h2>
<h2><?php echo $row_datos_canvas['recursos']; ?></h2>
 <h5 align="center">
 ...
 <h2><?php echo $row_datos_canvas['red']; ?></h2>
 <h5 align="center">
...
<li>El flujo de caja presentado contempla costos de operación fija como muebles y
 ...
 <li>(NOTA: A partir de los ceros no se cuenta)Valor Aproximado de este proyecto: <h3>$<?php echo $row_datos_vpn['resultado1'];?> Pesos
</h3></li>
<ul>
  <h2>Proyecciones </h2>
<li>El flujo de caja presentado contempla costos de operación fija como muebles y
...
funcionamiento, licencias de software, arriendo, costos de servicios públicos, entre
otros; la inversión nominal contempla el personal y gastos preoperativos, indicando
como resultado una inversión inicial de $<?php echo $row_datos_vpn['inicial']; ?> los cuales serán financiados
