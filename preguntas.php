...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO preguntas (pregunta, autor) VALUES (%s, %s)",
...
$todos = mysql_query($query_limit_todos, $crenesoft) or die(mysql_error());
...
$respuestas = mysql_query($query_respuestas, $crenesoft) or die(mysql_error());
...
<?php } else{?>
	...
	<div id="datos_personales" class="span5">
		<fieldset class="well">
			<legend>TU PREGUNTA</legend>
			<div class="span4">
              <form method="post" name="form1" action="<?php echo $editFormAction; ?>">
                <table align="center">
                  <tr valign="baseline">
                    <td nowrap align="right" valign="top"></td>
                    <td><textarea name="pregunta" cols="50" class="message" required placeholder="Aqui va tu pregunta" rows="5"></textarea> <span class = "big"> <a id="inte"><img src="/crenesoft/img/inte.png" /></a> </span></td>
                  </tr>
                  <tr valign="baseline">
                    <td nowrap align="right"></td>
                    <td><input type="text" name="autor" class="message"  placeholder="Tu nombre" required value="" size="32"></td>
                  </tr>
                  <tr valign="baseline">
                    <td nowrap align="right">&nbsp;</td>
                    <td><input type="submit" class="btn btn-primary" value="Preguntar"></td>
                  </tr>
                </table>
                <input type="hidden" name="MM_insert" value="form1">
 					...
 					<div class="span4">
						<fieldset class="well well-small">
							<legend>NOTA</legend>
							<p class="alert alert-warning">Un admintrador Respondera en el menor tiempo posible ---<strong>¡GRACIAS!</strong>.</p>
						</fieldset>
			  </div>
		  </div>	
		</fieldset>		
	...
	<div id="datos_usuario" class="span5">
		...
		<!--==============================================================-->
            ...
            <?php if(empty($row_todos)): ?>
             <p class="no_answer"> Aun no hay preguntas. se el primero en hacer una pregunta!!</p>
            ...
            <table width="123%" border="1" cellspacing="2" cellpadding="1">
               <tr >
                 <th  width="55%" bgcolor="#FFFFFF"    align="justify"   scope="row"><?php echo $row_todos['pregunta'];?></th><?php echo $row_respuestas['respuesta']; ?>
                 <th bgcolor="#00CCCC" width="37%"  align="center"  scope="row"><?php echo $row_todos['autor']; ?></th>
               </tr>
            </table>
          <?php } while ($row_todos = mysql_fetch_assoc($todos)); ?> <?php endif; ?>
          </div
              ><div class="span5">
