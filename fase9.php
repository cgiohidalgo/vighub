...
<title>Estructura de costo</title>
<!-- InstanceEndEditable -->
...
<fieldset class="well">
		<legend>Estructura de costo</legend>
       	  <div id="wrap">
			Los costos se genera automaticamente regresa y ve al boton de <a class="etapa">continuar con mi proceso</a>
		  <div id="tabs">
	    </div>
     </div>
</fieldset>
       
        <a class="btn btn-primary" href="modelo_canvas_index.php">Regresar a etapas</a>
		<!-- InstanceEndEditable -->
        </article>    	
    </section>
    <p>&nbsp;</p>
