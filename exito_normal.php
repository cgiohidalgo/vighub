...
$varUsuarios_datosusuarios = "0";
if (isset($_SESSION["MM_idusuario"])) {
  $varUsuarios_datosusuarios = $_SESSION["MM_idusuario"];
}
mysql_select_db($database_crenesoft, $crenesoft);
$query_datosusuarios = sprintf("SELECT * FROM usuarios WHERE usuarios.idusuario = %s", GetSQLValueString($varUsuarios_datosusuarios, "int"));
      ...
      <legend align="center">¡Felicitaciones ahora si deberás elegir si ponerle una portada con nombres a tu plan de negocios!</legend>
		...
		<fieldset class="well">
			...
			<div align="center" class="span4">
              <a class="btn btn-success" href="plan_de_negocios_normal_acabado.php">Ninguno</a>
        <a class="btn btn-success" href="nombre_uno.php">Uno</a>
          <a class="btn btn-success" href="nombre_dos.php">Dos</a>
           <a class="btn btn-success" href="nombre_tres.php">Tres</a>
