...
<?php if ((isset($_POST["enviado"])) && ($_POST["enviado"] == "form2")){
	...
	?>
    <script>  
    	opener.document.form2.imagen1.value="<?php echo $nombre_archivo; ?>";
		self.close();
    </script>
	<?php
}
...
?>
<form action="gestionimagen_plan_canvas1.php" method="post" enctype="multipart/form-data" id="form2">
