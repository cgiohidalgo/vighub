...
$query_Recordset1 = "SELECT * FROM usuarios ORDER BY usuarios.grupo";
...
<?php } else{?>
    ...
    <section id="principal">
        ...
        <p>&nbsp; </p>
        <table  width="50%" border="1" align="center" cellpadding="2" cellspacing="3">
  <tr class="lista">
    <th bgcolor="#3399FF" scope="col">Nombre Empresa</th>
    <th bgcolor="#3399FF" scope="col">¿Que hacer?</th>
  </tr>
  <?php do { ?>
    <tr>
