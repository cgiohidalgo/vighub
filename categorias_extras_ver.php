...
$query_Recordset1 = "SELECT * FROM categoria_extras ORDER BY categoria_extras.descripcion ASC";
...
<?php } else{?>
  ...
  <tr>
    ...
    <td align="center"><a href="categorias_extras_editar.php?recordID=<?php echo $row_Recordset1['idcategoria_extras']; ?>"><img src="imagenes/crenesoft/editar.png" width="38" height="38"></a>  <a href="categorias_extras_eliminar.php?recordID=<?php echo $row_Recordset1['idcategoria_extras']; ?>"><img src="imagenes/crenesoft/eliminar.png" width="38" height="38"></a></td>
  </tr>
  <?php } while ($row_Recordset1 = mysql_fetch_assoc($Recordset1)); ?>
        </table>
        <p><a href="categorias_extras_add.php">Añadir categoria de software</a></p>
		               </div>
           </fieldset>
           </div>
