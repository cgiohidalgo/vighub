...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE canvas SET red=%s WHERE idcanvas=%s",
...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form2")) {
  $updateSQL = sprintf("UPDATE imagenes_plan_canvas SET imagen8=%s WHERE idimgcanvas=%s",
...
<script> 
	  ...
	  remote = open('gestionimagen_plan_canvas8.php', 'remote', 'width=400, height=150, location=no, scrollbars=yes, menubars=no, resizable=yes, fullscreen=no, status=yes'); //propieades de las imagenes
	  remote.focus(); // esta ventanda que se abio pase a primer plano
	  }
  
  </script>
<fieldset class="well">
		<legend>Red de partners</legend>
         <p align="justify"><h4>Éstas se dan con quiénes subcontratas procesos o adquieres recursos clave.</h4></p>
       	  <div id="wrap">
            <form method="post" name="form1" action="<?php echo $editFormAction; ?>">
              <table align="center">
                <tr valign="baseline">
                  <td nowrap align="right" valign="top"></td>
                  <td><textarea name="red" cols="50" style="width:190%" rows="10"><?php echo htmlentities($row_conusltaCanvas['red'], ENT_COMPAT, 'utf-8'); ?></textarea></td>
                </tr>
                <tr valign="baseline">
...
<fieldset class="well">
  ...
  <table align="center" cellpadding="4" cellspacing="4">
    <tr valign="baseline">
      <td rowspan="2" align="right" nowrap><img src="imagenes/plan_canvas/<?php echo $row_imageness['imagen8']; ?>" width="190" height="100"></td>
      <td><input type="button" name="button" onClick="javascript:cargarimagenocho();" class="btn btn-success" title="Si deseas saber como hacer un logo o imagen PNG con photoshopCS6 escribe en el link de ¿Dudas?" id="button" value="Cargar imagen"></td>
    </tr>
    <tr valign="baseline">
