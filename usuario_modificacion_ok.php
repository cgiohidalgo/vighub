...
<?php } else{?>
    ...
    <section id="principal">
    	<article> 
		<!-- InstanceBeginEditable name="Contenido" --><h1>Tus datos se han actualizado correctamente</h1>
		<p>&nbsp;</p>
		<h2 align="center"><a  href="inicio.php">volver</a></h2><!-- InstanceEndEditable -->
        </article>    	
    </section>
    <p>&nbsp;</p>
