...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE planes SET nombre_uno=%s, nombre_dos=%s WHERE idplan=%s",
...
$varUsuario_datosnombresdos = "0";
if (isset($_SESSION["MM_idusuario"])) {
  $varUsuario_datosnombresdos = $_SESSION["MM_idusuario"];
}
mysql_select_db($database_crenesoft, $crenesoft);
$query_datosnombresdos = sprintf("SELECT * FROM planes WHERE planes.idplan = %s", GetSQLValueString($varUsuario_datosnombresdos, "int"));
$datosnombresdos = mysql_query($query_datosnombresdos, $crenesoft) or die(mysql_error());
$row_datosnombresdos = mysql_fetch_assoc($datosnombresdos);
$totalRows_datosnombresdos = mysql_num_rows($datosnombresdos);
?>
<!doctype html>
        ...
        <form method="post" name="form1" action="<?php echo $editFormAction; ?>">
          <table align="center">
            <tr valign="baseline">
              ...
              <td><input type="text" required placeholder="Escribe el nombre del autor" title="ej: Giovanny Hidalgo Suarez" name="nombre_uno" value="<?php echo htmlentities($row_datosnombresdos['nombre_uno'], ENT_COMPAT, 'utf-8'); ?>" size="32"></td>
            </tr>
            <tr valign="baseline">
              
              <td><input type="text" required placeholder="Escribe el nombre del autor" title="ej: Giovanny Hidalgo Suarez" name="nombre_dos" value="<?php echo htmlentities($row_datosnombresdos['nombre_dos'], ENT_COMPAT, 'utf-8'); ?>" size="32"></td>
            </tr>
            <tr valign="baseline">
          ...
          <input type="hidden" name="idplan" value="<?php echo $row_datosnombresdos['idplan']; ?>">
        </form>
        </div>
      </fieldset>
      </div>
...
<!-- InstanceEnd --></html>
<?php
mysql_free_result($datosnombresdos);

mysql_free_result($datosnombres);
