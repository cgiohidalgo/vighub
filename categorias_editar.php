...
mysql_select_db($database_crenesoft, $crenesoft);
$query_cosnultaeditcate = sprintf("SELECT * FROM categoria WHERE categoria.idcategoria = %s", GetSQLValueString($varCate_cosnultaeditcate, "int"));
    ...
    <div id="contenedor_formulario" class="well">
      ...
      <legend align="center">¡Categorias!</legend>
        ...
        <form method="post" name="form1" action="<?php echo $editFormAction; ?>">
          ...
          <input type="hidden" name="idcategoria" value="<?php echo $row_cosnultaeditcate['idcategoria']; ?>">
        </form>
         </div>
      </fieldset>
      </div>  
