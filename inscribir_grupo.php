...
if (isset($_POST[$MM_flag])) {
  $MM_dupKeyRedirect="inscribir_error.php";
  $loginUsername = $_POST['nombre_grupo'];
  $LoginRS__query = sprintf("SELECT nombre_grupo FROM grupos WHERE nombre_grupo=%s", GetSQLValueString($loginUsername, "text"));
...
<?php } else{?>
    ...
    <section id="principal">
		...
		<p>Inscripción de grupo</p>
		<p>&nbsp;</p>
        <form method="post"  name="form1" action="<?php echo $editFormAction; ?>">
          <table align="center">
            <tr valign="baseline">
              <td nowrap align="right"></td>
              <td><input type="text" placeholder="Nombre de Empresa" required name="nombre_grupo" value="" size="32"></td>
            </tr>
            <tr valign="baseline">
              <td nowrap align="right">&nbsp;</td>
              <td><input type="submit" value="Comprobar Nombre"></td>
            </tr>
          </table>
