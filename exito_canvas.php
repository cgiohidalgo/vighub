...
$query_Recordset1 = sprintf("SELECT * FROM costo_total WHERE costo_total.idcosto_total = %s", GetSQLValueString($varUsuario_Recordset1, "int"));
$Recordset1 = mysql_query($query_Recordset1, $crenesoft) or die(mysql_error());
$row_Recordset1 = mysql_fetch_assoc($Recordset1);
$totalRows_Recordset1 = mysql_num_rows($Recordset1);

$varUsarios_datosusuarios = "0";
if (isset($_SESSION["MM_idusuario"])) {
  $varUsarios_datosusuarios = $_SESSION["MM_idusuario"];
}
mysql_select_db($database_crenesoft, $crenesoft);
$query_datosusuarios = sprintf("SELECT * FROM usuarios WHERE usuarios.idusuario = %s", GetSQLValueString($varUsarios_datosusuarios, "int"));
$datosusuarios = mysql_query($query_datosusuarios, $crenesoft) or die(mysql_error());
...
<title>Proceso_bien - <?php echo $row_datosusuarios['grupo']; ?></title>
<!-- InstanceEndEditable -->
...
<?php } else{?>
    ...
    <section id="principal">
       ...
       <fieldset class="well">
      <legend align="center">¡Felicitaciones ahora si deberás elegir si ponerle una portada con nombres a tu plan de negocios!</legend>
		...
		<fieldset class="well">
			...
			<!--==============================================================-->
			<legend align="center">¿cuantos nombres irán en tu proyecto de plan de negocio?</legend>
			<div align="center" class="span4">
             <a class="btn btn-success" href="plan_de_negocios_canvas_acabado.php">Ninguno</a>
        <a class="btn btn-success" href="nombre_uno_c.php">Uno</a>
          <a class="btn btn-success" href="nombre_dos_c.php">Dos</a>
           <a class="btn btn-success" href="nombre_tres_c.php">Tres</a>         </select>
