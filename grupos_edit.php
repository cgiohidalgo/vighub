  ...
  <div id="contenedor_formulario" class="well">
      ...
      <legend align="center">¡Usuarios!</legend>
        ...
        <form method="post" name="form1" action="<?php echo $editFormAction; ?>">
         <input type="text" name="grupo" value="<?php echo htmlentities($row_Recordset1['grupo'], ENT_COMPAT, 'utf-8'); ?>" size="32"><input type="text" name="email" value="<?php echo htmlentities($row_Recordset1['email'], ENT_COMPAT, 'utf-8'); ?>" size="32"><input type="text" name="password" value="<?php echo htmlentities($row_Recordset1['password'], ENT_COMPAT, 'utf-8'); ?>" size="32">
   <select name="activo">
           <option value="1" <?php if (!(strcmp(1, htmlentities($row_Recordset1['activo'], ENT_COMPAT, 'utf-8')))) {echo "SELECTED";} ?>>activo</option>
              ...
              </select><input type="text" name="imagen" id="imagen" value="<?php echo htmlentities($row_Recordset1['imagen'], ENT_COMPAT, 'utf-8'); ?>" size="32">
              <input type="button" name="button" class="btn btn-success" title="Si deseas saber como hacer un logo PNG con photoshop escribe en el link de ¿Dudas?" onClick="javascript:cargarimagen();" id="button" value="Subir logo"><input type="submit" class="btn btn-primary" value="Actualizar registro">
              </div>
           </fieldset>
           </div>
