...
<?php } else{?>
    ...
    <section id="principal">
		...
		<!-- InstanceBeginEditable name="Contenido" -->      
                 <h1>El el correo ya esta registrado en nuestra Base de datos.</h1>
  <p>&nbsp;</p>
  <h3>Prueba con otro correo<a href="registrar.php"><img src="imagenes/crenesoft/click_aqui.gif" width="100" height="100"></a>
  </h3>
  <p>&nbsp;</p>
