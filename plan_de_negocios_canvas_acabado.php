...
$varUsuarios_datosusuario = "0";
if (isset($_SESSION["MM_idusuario"])) {
  $varUsuarios_datosusuario = $_SESSION["MM_idusuario"];
}
mysql_select_db($database_crenesoft, $crenesoft);
$query_datosusuario = sprintf("SELECT * FROM usuarios WHERE usuarios.idusuario = %s", GetSQLValueString($varUsuarios_datosusuario, "int"));
$datosusuario = mysql_query($query_datosusuario, $crenesoft) or die(mysql_error());
...
<title>Canvas_Finalizado - <?php echo $row_datosusuario['grupo']; ?></title>
<!-- InstanceEndEditable -->
...
<?php } else{?>
    ...
    <section id="principal">
       ...
       <fieldset class="well">
      <legend align="center">Felicitaciones hemos terminado, un placer para nosotros haber podido ayudar. Ahora tú ya puede generar tu Plan de Negocios en un documento Word o PDF.</legend>
		...
		<fieldset class="well">
			...
			<div align="center" class="span4">
				<a class="btn btn-success" href="exporta_word_c.php">Exportar Word</a>
                <a class="btn btn-success" href="exporta_pdf_c.php">Exportar PDF</a>
           </div>
           </fieldset>
           </div>
			...
			<legend align="center">Nombre de integrante</legend>
			<div align="center" class="span4">
				<a class="btn btn-success" target="_blank" href="visualiza_c.php">Visualizar en pantalla</a>
           </div>
           </fieldset>
           </div>
