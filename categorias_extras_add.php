    ...
    <section id="principal">
      ...
      <legend align="center">¡Categorias!</legend>
		...
		<fieldset class="well">
			...
			<!--==============================================================-->
			<legend align="center">Nueva categorias</legend>
			<div align="center" class="span4">
       <form method="post" name="form1" action="<?php echo $editFormAction; ?>">
         <input type="text" name="descripcion" required placeholder="Escribe la categoria" value="" size="32">
         <br></br>
