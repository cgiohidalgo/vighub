...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE categoria_extras SET descripcion=%s WHERE idcategoria_extras=%s",
  ...
  $updateGoTo = "categorias_extras_ver.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
$varCate_cosnultaeditcate = "0";
if (isset($_GET["recordID"])) {
  $varCate_cosnultaeditcate = $_GET["recordID"];
}
mysql_select_db($database_crenesoft, $crenesoft);
$query_cosnultaeditcate = sprintf("SELECT * FROM categoria_extras WHERE categoria_extras.idcategoria_extras = %s", GetSQLValueString($varCate_cosnultaeditcate, "int"));
$cosnultaeditcate = mysql_query($query_cosnultaeditcate, $crenesoft) or die(mysql_error());
$row_cosnultaeditcate = mysql_fetch_assoc($cosnultaeditcate);
$totalRows_cosnultaeditcate = mysql_num_rows($cosnultaeditcate);
?>
<!doctype html>
    ...
    <div id="contenedor_formulario" class="well">
      ...
      <legend align="center">¡Categorias!</legend>
        ...
        <form method="post" name="form1" action="<?php echo $editFormAction; ?>">
          <input type="text" required placeholder="Escribe la categoria" name="descripcion" value="<?php echo htmlentities($row_cosnultaeditcate['descripcion'], ENT_COMPAT, 'utf-8'); ?>" size="32">
          ...
          <input type="hidden" name="idcategoria" value="<?php echo $row_cosnultaeditcate['idcategoria_extras']; ?>">
        </form>
         </div>
      </fieldset>
      </div>  
...
<!-- InstanceEnd --></html>
<?php
mysql_free_result($cosnultaeditcate);
