...
<title>Normal_Finalizado - <?php echo $row_datosusuario['grupo']; ?></title>
<!-- InstanceEndEditable -->
      ...
      <legend align="center">Felicitaciones hemos terminado, un placer para nosotros haber podido ayudar. Ahora tú ya puede generar tu Plan de Negocios en un documento Word o PDF.</legend>
		...
		<fieldset class="well">
			...
			<div align="center" class="span4">
				<a class="btn btn-success" href="exporta_word.php">Exportar Word</a>
                <a class="btn btn-success" href="exporta_pdf.php">Exportar PDF</a>
           </div>
           </fieldset>
           </div>
			...
			<legend align="center">Nombre de integrante</legend>
			<div align="center" class="span4">
				<a class="btn btn-success" target="_blank" href="visualiza.php">Visualizar en pantalla</a>
           </div>
           </fieldset>
           </div>
